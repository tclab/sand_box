...
public class GtdMidlet extends MIDlet implements CommandListener, ItemStateListener {
    ...
    private Command verCalendario, salir, atras, atrasMover, atrasNota, nueva,
            mover, guardarNotaTexto, guardarNotaSonido, moverNota, detalle,
            atrasDetalle, eliminar, editarTexto, parar, grabar, enviar;
    ...
    private int listaActual, tipoNota;
    private CommandListener deListaMover;
    private String notaAMover, detalleDeNota, notaEliminar;
    private TextBox detalleNota;
    private byte[] sonido;
    private final int TEXTO = 1;
    private final int SONIDO = 2;
    private final int DIBUJO = 3;
    private Image iTexto, iSonido, iDibujo;
...
//        try {
//            iTexto = Image.createImage(getClass().getResourceAsStream("texto.png"));
//
//            iSonido = Image.createImage(getClass().getResourceAsStream("sonido.png"));
//
//        } catch (IOException ex) {
//            ex.printStackTrace();
//        }

        verCalendario = new Command("Ver calendario", Command.SCREEN, 1);
        ...
        guardarNotaSonido = new Command("Guardar", Command.OK, 1);
        moverNota = new Command("Mover nota", Command.OK, 1);
        detalle = new Command("Detalle", Command.SCREEN, 1);
        atrasDetalle = new Command("Atras", Command.EXIT, 1);
        eliminar = new Command("Eliminar", Command.OK, 1);
        editarTexto = new Command("Guardar", Command.OK, 1);
        parar = new Command("Parar", Command.OK, 1);
