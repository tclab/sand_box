...
public class TNotasDAO {
	 ...
	 */
	public TNotasDAO open() throws SQLException {
	 ...
	 * @return Cursor over all notes
	 */
	public Cursor fetchAllCoor() {

		return mDb.query(DATABASE_TABLE, new String[] { KEY_LAT, KEY_LNG },
